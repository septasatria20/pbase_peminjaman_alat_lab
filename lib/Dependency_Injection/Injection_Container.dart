...
// History
import '../features/domain/repositories/history_repository.dart';
import '../features/data/repositories/history_repository_impl.dart';
import '../features/presentation/providers/history_provider.dart';
...
void setupDependencyInjection() {
  ...
  sl.registerFactory(() {
    ...
    return AuthProvider(sl<AuthRepository>(), sl<FirebaseFirestore>());
  });
