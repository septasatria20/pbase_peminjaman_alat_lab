...
class DetailAlatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: _buildFloatingButton(context, firestore),
  ...
  Widget _buildFloatingButton(BuildContext context, FirebaseFirestore f) {
    return FutureBuilder<DocumentSnapshot>(
      future: f.collection("alat").doc(alatId).get(),
        ...
        return SizedBox(
          ...
          child: FloatingActionButton.extended(
            onPressed: isTersedia
                ...
                : null,
            backgroundColor: isTersedia ? colorMaroon : Colors.grey[400]!,
            elevation: 4,
            label: Row(
